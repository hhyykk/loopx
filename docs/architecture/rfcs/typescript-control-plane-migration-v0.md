...
| Product-code net change | 2,720 added minus 831 deleted product LOC, net +1,889; tests/examples are separately +671 and docs are excluded. The temporary increase buys one complete transaction and cannot repeat: the next deletion is the 495-line bridge when quota decision, Todo persistence, status projection, and remaining index writers are native. |
